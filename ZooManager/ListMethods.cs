...
namespace ZooManager
{
    public class ListMethods
    {
        ...
        private static Animal FindAnimalObject(string animal, List<Animal> list)
        {
        ...
        public static void RemoveAnimalObject(string animalToDelete, List<Animal> list)
        {
        ...
        public static bool IsListEmpty(List<Animal> list) 
        {
            if (list.Count == 0)
            {
                return false;
